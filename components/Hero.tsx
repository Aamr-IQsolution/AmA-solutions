/**
 * قسم الواجهة الترحيبية (Hero Section) — إرث التصميم الداكن.
 * [Phase 1] الصفحة الرئيسية تستخدم HomeHero.tsx داخل .new-design-wrapper بدلاً من هذا المكوّن.
 * يُبقى الملف للرجوع إليه أو لإعادة الاستخدام لاحقاً — لا تُحذف منطقياً من المشروع.
 */
